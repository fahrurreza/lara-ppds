                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <h4 class="header-title" style="text-align: right;margin-right:20px;margin-top:10px;"><button
                                ...
                                data-bs-target="#standard-modal">New Extrakulikuler</button></h4>
                        @endif
                        <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="btn btn-outline-primary btn-sm"
                                                        ...
                                                        data-description="{{$list->extrakulikuler->description}}"
        ...
        @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="standard-modalLabel">Form Data Extrakulikuler</h4>
