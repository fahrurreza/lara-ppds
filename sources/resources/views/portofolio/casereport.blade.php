                ...
                <form method="POST" action="" enctype='multipart/form-data' novalidate>
                    ...
                    <div class="row g-2">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" name="presenter_name" id="presenter_name" disabled>
                        </div>
                        <div class="mb-3 col-md-6">
                    ...
                    <div class="row g-2">
                        <div class="mb-3 col-md-12">
                            <img id="path" width="500" height="450">
                        </div>
                    </div>
                    *Note Revision
...
<script>
    $('#modaledit').on('show.bs.modal', function(event) {
        ...
        var presenter_name = button.data('presenter_name')
        ...
        modal.find('#presenter_name').val(presenter_name)
